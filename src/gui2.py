...
class simpleapp_tk(Tkinter.Tk):
    ...
    def initialize(self):
        ...
        label1 = Tkinter.Label(self, fg="black", bg="white", textvariable=self.text1)
        ...
        label2 = Tkinter.Label(self, fg="black", bg="white", textvariable=self.text2)
        ...
        options['initialdir'] = os.getcwd() #'C:\\'
